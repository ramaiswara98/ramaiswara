...
function AboutMe() {
  return (
    <div className=' h-min-screen flex md:flex-row flex-col align-middle justify-center'>
        <div className='flex flex-col md:w-1/2 align-middle justify-center md:order-1 order-2'>
            ...
            <p className=' text-white text-lg text-left whitespace-pre-line'>{Constan.ABOUTME}</p>
        </div>
        <div className='flex flex-col md:w-1/2 justify-center items-end md:order-2 order-1'>
            <div className='flex rounded-full bg-gradient-to-b from-[#18ADB3] to-[#595A85] to-70% p-14 justify-center align-middle mt-5 h-fit w-fit'>
                <img src={Baby2} />
            </div>
        </div>
    </div>
