  ...
  return (
    <div className=' h-screen flex md:flex-row flex-col'>
       <div className='flex flex-col md:w-1/2 justify-center md:order-1 order-1 items-start'>
            <div className='flex rounded-full bg-gradient-to-b from-[#18ADB3] to-[#595A85] p-14 justify-center mt-5 h-fit w-fit'>
        ...
        <div className='flex flex-col md:w-1/2 md:items-center justify-center md:order-1 order-1 gap-3'>
            ...
            <div className='flex flex-row items-center gap-3 mt-2'>
                <div className='rounded-full bg-gradient-to-b from-[#18ADB3] to-[#595A85] w-12 flex flex-row justify-center h-12'>
                    <img src={CFA} />
                </div>
                <div>
            ...
            <div className='flex flex-row items-center gap-3 mt-2'>
                <div className='rounded-full bg-gradient-to-b from-[#18ADB3] to-[#595A85] w-12 flex flex-row justify-center h-12 items-center'>
