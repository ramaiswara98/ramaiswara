...
import ACKTEC from '../../assets/images/acktec.png'
  ...
  return (
    <div className=' h-screen flex md:flex-row flex-col'>
       <div className='flex flex-col md:w-1/2 justify-center md:order-1 order-1 items-start'>
        ...
        <div className='flex flex-col md:w-1/2 md:ml-60 justify-center md:order-1 order-1 gap-3'>
            ...
            <div className='flex flex-row items-center gap-3 mt-2'>
                <div className='rounded-full bg-gradient-to-b from-[#18ADB3] to-70% to-[#595A85] w-12 flex flex-row justify-center h-12'>
                    <img src={ACKTEC} width={28} height={28}/>
                </div>
                <div>
                    <p className='text-white font-bold text-3xl text-left'>ACKTEC Technologies</p>
